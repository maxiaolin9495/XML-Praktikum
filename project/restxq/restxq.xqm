  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
      ...
      <p>The Database Administration interface is completely
        ...
        web applications can be built with XQuery.</p>
      
      <h3><a href="htmlforms">BJ: Black Jack</a></h3>

      <p>The game black jack can be accessed by clicking on the link above.</p>
    </body>
  </html>
};
